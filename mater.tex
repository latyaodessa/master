...
\begin{itemize}
	...
	\item Welche weiteren Fragen entstanden während der Arbeit? In welche Richtung könnte die Forschung weitergehen?
\end{itemize} 
...
Hier ist Platz daf\"ur, sich bei Eltern, Freunden etc. zu bedanken, sofern das gewünscht ist. Etwaige F\"ordergeber nicht vergessen.   
...
\begin{enumerate}
	...
	\item Wieso wird das jetzt behandelt und nicht schon früher?
 \end{enumerate}
...
verwendet werden. 
\\
Als Beispiel der gewünschten Zitierart wird der Zitierstil im Journalartikel \cite{Bauer_Wagner_ET_2012} verwendet. 
...
\item Welche Anwendungen können mit Hilfe des neuen Wissens realisiert werden?
